...
// multiply endpoint.
func DecodeMultiplyRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (*calc.MultiplyPayload, error) {
	return func(r *http.Request) (*calc.MultiplyPayload, error) {
		var (
			a   int
			b   int
			err error
